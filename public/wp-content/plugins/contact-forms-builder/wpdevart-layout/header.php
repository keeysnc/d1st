...
<header class="header">
    <div class="main-bar">
        ...
        <div class="col-sm-7">
            <div class="theme-info">
                <div class="theme-version"><span>V <?php echo wpda_form_PLUGIN_VERSION; ?></span><a target="_blank" href="http://wpdevart.com/wordpress-contact-form-plugin" style="color: #B4272C; font-weight: bold; font-size: 18px;text-decoration: none;">(Upgrade to Pro Version)</a><a target="blank" href="<?php echo wpdevart_contactform_support_url; ?>" class="wp_support">Support</a></div>
	...
	<?php
		if( wp_get_theme() == 'wpdevart' || wp_get_theme() == 'wpdevart Child' || wp_get_theme() == 'wpdevart Theme' || wp_get_theme() == 'wpdevart Child Theme' ) {
				//	If WpDevArt contact form theme is active, then we don't add sidebar menu because
				//	WpDevArt contact form theme automatically add sidebar menu items under WpDevArt tab
	?>
    <div class="lower-bar">
